...
func (m *MockUserRepository) FindAll(ctx context.Context, limit, offset int) ([]*model.User, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) FindAll(ctx, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
